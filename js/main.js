        ...
        if (container.length == 0)
            ...
            if (scale > 1) 
                ...
                if (isDesktop | isTablet) {
                    container.find('.banner-container').css({transform: 'scale('+(1-scale/4)+')'});
...
/* Make logo scroll to top of page
   -----------------------------------------------------*/
...
/* Design sprint links
   -----------------------------------------------------*/
    $('.design-sprint ul li a').click(function(){
        var href = $(this).attr('href');
        var sprintPosition = $(href).offset().top - $('#nav-container').height();
...
/* Lightbox
   -----------------------------------------------------*/
    ...
    if (!/android|iphone|ipod|series60|symbian|windows ce|blackberry/i.test(navigator.userAgent)) {
        jQuery(function($) {
            $("a[rel^='lightbox']").slimbox({initialWidth: 300, initialHeight: 300, resizeDuration: 200, closeKeys: [27]}, null, function(el) {
